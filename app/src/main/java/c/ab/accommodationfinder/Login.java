...
public class Login extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iL = new Intent(Login.this, UserRegistration.class);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
        ...
        } else if (Helper.validateUser(email, password)) {
            //Toast.makeText(LoginActivity.this, "allowed", Toast.LENGTH_SHORT).show();
            startManagingCursor(Helper.cursor);
            ...
            //Toast.makeText(Login.this, "Successfully Login: " + email, Toast.LENGTH_LONG).show();
        } else {
            ...
            ed.putString(KEY_NAME, email);
            ed.putString(KY_PHONE, password);
            ed.commit();
        }
    }
